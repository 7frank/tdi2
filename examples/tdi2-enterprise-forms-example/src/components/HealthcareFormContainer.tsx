...
export function HealthcareFormContainer({ services }: HealthcareFormContainerProps) {
        ...
        return (
          <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <div style={{ 
              ...
              <h3>Summary</h3>
              <p><strong>Forms Completed:</strong> {completedNodes.length}</p>
              <p><strong>Patient:</strong> {formDAG.state.formData.demographics?.firstName} {formDAG.state.formData.demographics?.lastName}</p>
              <p><strong>Age:</strong> {formDAG.state.formData.demographics?.age}</p>
              <p><strong>Insurance:</strong> {formDAG.state.formData.insurance?.primaryInsurance?.provider}</p>
              <p><strong>Plan Type:</strong> {formDAG.state.formData.insurance?.primaryInsurance?.planType}</p>
            </div>
          </div>
        );
    }
