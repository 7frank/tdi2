 ...
 *   ({title, services}) => { ... }
 */
export type DIComponent<TServices extends ServiceDependencies, TProps = object> = DIFunction<TServices, TProps>;
/**
 ...
 */
export declare function withDI<TServices extends ServiceDependencies, TProps = object>(component: (props: TProps & {
    services: ExtractServices<TServices>;
