// Auto-generated transformation snapshot for NestedDestructuringWithRest
// Generated: 2025-08-25T18:16:22.191Z
...
export function NestedDestructuringWithRest(
  props: {
    ...
    const { config: { ui: { theme, colors, uiRest }, api: { baseUrl, apiRest } }, id, ...restProps } = props;
