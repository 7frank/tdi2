 ...
 * Example: withServices({ api: 'EXAMPLE_API_TOKEN' })(MyComponent)
 */
export function withServices<TServices extends Record<string, any>>(
  serviceMap: { [K in keyof TServices]: string | symbol }
) {
  return function <TProps extends {}>(
    Component: React.ComponentType<TProps & { services: TServices }>
  ): React.ComponentType<TProps> {
    const WrappedComponent = (props: TProps) => {
      const services = useServices(serviceMap);
